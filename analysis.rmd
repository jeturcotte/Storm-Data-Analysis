...
We seem to have a lot of items listed as *summary*.  This isn't particularly useful as an EVTYPE, but they did seem to get special care, so let's take a quick look at what's going on inside their REMARKS.

```{r checking out summary items}
summaries <- storms[grep("summary",storms$EVTYPE),]
```
